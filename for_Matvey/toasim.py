...
def add_cgw(
    ...
    """
    """
    Custom code beginning Part 1
    """
    #dzeta = psrTerm_omega/EarthTerm_omega
    #psrTerm_omega = omega_p
    #EarthTerm_omega = omega
    #from this point we have to define omega_p as described below:
    #omega_p = omega*dzeta
    
    """
    Custom code ending Part 1
    """
    ...
    # no evolution 
        ...
        phase_p = N.random.uniform(0,2*N.pi)
        
#    Custom code ending Part 2
    ...
    """
    Custom code beginning Part 3
    """
    #devided Term appearance
    if Term == "psr_only":
        res = fplus * rplus_p + fcross * rcross_p
